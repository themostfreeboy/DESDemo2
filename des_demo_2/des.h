...
void ByteToBit(bool *DatOut,const char *DatIn,int Num);//字节到位
void BitToByte(char *DatOut,const bool *DatIn,int Num);//位到字节

void BitToHex(char *DatOut,const bool *DatIn,int Num);//二进制到十六进制 64位 to 4*16字符
void HexToBit(bool *DatOut,const char *DatIn,int Num);//十六进制到二进制

void TablePermute(bool *DatOut,const bool *DatIn,const char *Table,int Num);//位表置换函数
